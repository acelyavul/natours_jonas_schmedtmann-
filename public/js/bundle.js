...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWNlbHlhdiIsImEiOiJja3Z3a20wMDljNnppMzBzN3lzMHNtMHk0In0.LV9mRnFbv8fmwHIZDGPUiA';
...
}; // type is 'success' or 'error', default is 7 seconds
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, password, password2) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
//data is an object which contains email & name or current & new passwords
...
var stripe = Stripe('pk_test_51K0jEMBBUFq3L6J2pRtk3LdbK0CpRSZI16ZzjwqrutAp3extWaU7B1cn3vsOIj8xNRTNcWzdiC8ZK3NOBfK8E37Y00BusB1Mh3');
...
if (logOutBtn) logOutBtn.addEventListener('click', _login.logout); //for test purposes, not working
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _signup.signup)(name, email, password, password2);
}); //Update name and email on form

if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault(); //we basically recreate this multipart form data
...
}); //Update password on account of website
